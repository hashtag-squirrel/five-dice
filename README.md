...
<span style="color:red">WIP</span> Write text about website
...
- roll dice, indicate how many rolls left per turn
- lock dice 
- pick field for current turn and end turn once picked
- add rules somewhere
...
- Cosmetic additions:
    ...
    - Change theme of game area -> save in localstorage
    - Animate dice roll

- Functional additions:
    - 2 Player Game
    - Player vs. Computer Game
    - Helper -> precalculates potential scores and makes decisioning easier
...
- Other potential dice sets:
https://pixabay.com/vectors/dice-games-game-six-sided-face-26772/
https://pixabay.com/vectors/dice-one-two-three-four-five-six-335026/
